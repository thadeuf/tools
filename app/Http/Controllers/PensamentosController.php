...
class PensamentosController extends Controller
{
    /**
    ...
    public function save(Request $request)
{
    ...
    $fileName = "pensamentos_" . $currentDateTime . ".json";
    ...
    return redirect('/pensamentos')->with('success', 'Dados salvos com sucesso!');
}
...
public function showResults(Request $request)
{
    ...
    return view('presults', ['results' => $result, 'fileOptions' => $fileOptions, 'selectedFile' => $selectedFile]);
}
